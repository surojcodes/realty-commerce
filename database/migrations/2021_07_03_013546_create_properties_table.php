...
class CreatePropertiesTable extends Migration
{
    public function up()
    {
        Schema::create('properties', function (Blueprint $table) {
            ...
            $table->text("AerialPhotoAvailableYN")->nullable();
            ...
            $table->text("DockPermittedYN")->nullable();
            ...
            $table->text("AppFeePayableTo")->nullable();
            $table->text("AppFeePlus18YrsYN")->nullable();
            $table->text("ApplicationFeeAmount")->nullable();
